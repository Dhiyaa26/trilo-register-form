  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={campusImage} alt="Universitas Trilogi Campus" className="w-full h-full object-cover" />
      ...
      <div className="relative container mx-auto px-6 py-32">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-foreground/15 backdrop-blur-sm mb-6">
            ...
            <span className="text-primary-foreground/90 text-sm font-medium">Admissions Open 2026/2027</span>
          </div>
          ...
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-lg leading-relaxed">
            Join Universitas Trilogi and shape the future of innovation. Start your academic journey at one of Indonesia's leading private universities.
          </p>
